...
NDefines.NAI.AGGRESSIVENESS_BONUS_EASY_WAR = 700							-- Added to aggressiveness if the war is against a weak or particularily hated enemy
NDefines.NAI.TRADE_INTEREST_THRESHOLD = 4 									-- Number of merchants required to be a nation with trade interest

NDefines.NAI.INVADING_BRAVERY = 5.0											-- If (defender strength) / (invader strength) > INVADING_BRAVERY, the AI won't attempt a naval invasion
NDefines.NAI.INVADING_MAX_AWAY_RATIO = 0.95									-- AI will never send more than this ratio to invade (Measured in strength)
